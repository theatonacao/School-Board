  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="overview-boxes">
        ...
        <div class="box bttns " style="width:49%; cursor: pointer;" onclick="window.location='student_promotion.php';">
          <div class="right-side" >
      ...
      <div class="sales-boxes">
        <div class="recent-sales box" style="width:100%">
          <div class="title">All Class Information</div>
          <div class="search-box">
            <i class='bx bx-search' style="font-size:2rem;" ></i>
            <input class="searchbar" type="text" id="myInput" style="width:96%; height: 40px; padding: 10px; justify-content: center;float:right; font-size: 1rem; border-radius: 15px 30px 30px 15px; background: #F5F6FA;border: 2px solid #EFEEF1;" onkeyup="performSearch()" placeholder="Search by LRN, Name, Grade Level, Section, Adviser..."  title="Type in keyword">
          ...
          <table id="myTable" style="border: 1px solid black; border-collapse: collapse;width: 100%">
            ...
            <tr class="header">	
              ...
              <th class="text2">Section Name</th>
              <th class="text2">Adviser</th>
            ...
            <tbody style="border: 1px solid black; border-collapse: collapse;">
              ...
              <?php
              $result = mysqli_query($con,"SELECT `teachers`.`year`, `teachers`.`advisorysec`, `teachers`.`lastname`, `teachers`.`firstname` FROM `teachers` ORDER BY cast(`teachers`.`year` AS unsigned);");
              ...
              echo "<td style='text-align:center'><a href='class_display.php?id=". $row['advisorysec'] .  "'><button type='submit' name='view_data' style='background-color: #95B46A; border: none; border-radius: 20px; color: #333; /* Dark grey */ padding: 10px 27px;cursor: pointer; '>Preview</button></a></td>";
              echo "</tr>";
              }
