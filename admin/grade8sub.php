    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box" style="width:100%">
          <div class="title"><a href="e_learningperglvl.php"><i class='bx bxs-left-arrow-circle'></i></a></i> Grade 8
          </div>
          ...
          <br>
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Filipino' ORDER BY quarter_no");
              $i=0;
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'English'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Mathematics'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Science'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Araling Panlipunan'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Technical and Livelihood Education(TLE)'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Music'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Arts'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Physical Education'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Health'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Edukasyon sa Pagpapakatao (EsP)'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
            ...
            <?php
              ...
              $result = mysqli_query($con,"SELECT * From files WHERE `files`.`gradelvl` = 'Grade 8' AND `files`.`subjec_t` = 'Other'");
              $i=0;
              while($row = mysqli_fetch_array($result))
              {
              echo "<tr>";
