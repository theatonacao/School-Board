  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="mygrades.php"  class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">My Grades</span>
      </div>
...
<!-- INSERT HERE -->
                           <div class="" style="font-size: 15px;">
                                                ...
                                                <table style="width: 1100px;margin-left: auto; margin-right: auto; border-collapse: collapse;">
                                                ...
                                                <table style="width: 1100px; font-size: 15px; margin-left: auto; margin-right: auto; text-align: center; line-height: 0.002px; border-collapse: collapse;">
                                                    <tbody>
                                                        <tr >
                                    ...
                                    <!-- Edukasyon sa Pagpapakatao -->
                                                        <tr style="">
                                                            <td style="width: 141px; text-align: left;">&nbsp;Edukasyon sa Pagpapakatao</td>
                                    ...
                                    <!-- MAPEH (Average) -->
                                                            ...
                                                            <td style="width: 90px; ">
                                                                <?php $gMAPEH=round(getAverage($M1,$M2,$M3,$M4),2);
                                                                      if ($gMAPEH!=0) {
                                                                         echo $gMAPEH;
                                                                      }else{
                                                                        echo '';
                                    ...
                                    <!-- FINAL GRADE -->    <td style="width: 90px; " rowspan="2"> 
                                                                <?php $final =  round(getAverage($q1,$q2,$q3,$q4), 2);
                                                                        ...
                                                                        ?> </td>
                                    <!-- FINAL REMARKS --><td style="width: 97px; " rowspan="2"> 
                                                                    <?php 
